...
var encodedData = require('soop').load('reddcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('reddcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('reddcore/lib/Address', {
