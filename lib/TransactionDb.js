...
var encodedData = require('soop').load('opalcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('opalcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('opalcore/lib/Address', {
